            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if (auth()->user()->selectRole('accounts')->permissionCount() < 1 ||
                            auth()->user()->selectRole('accounts')->hasPermission('category_type_add'))
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @forelse ($sub_categories as $subcat)
                                        <tr>
                                            ...
                                            <td>
                                                @if (auth()->user()->selectRole('accounts')->permissionCount() < 1 ||
                            auth()->user()->selectRole('accounts')->hasPermission('category_type_edit'))
                                                <a href="javascript:void(0)" data-toggle="modal" data-target="#edtiSubCategory{{$subcat->id}}" class="btn btn-info">Edit</a>
                                                @endif
                                                @if (auth()->user()->selectRole('accounts')->permissionCount() < 1 ||
                            auth()->user()->selectRole('accounts')->hasPermission('category_type_delete'))
