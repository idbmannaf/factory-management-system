...
@section('content')
    ...
    auth()->user()->selectRole('production')->hasPermission('raw_materials_add'))
                                ...
                                <tbody>
                                    @forelse($rawMaterials as $raw)
                                        <tr>
                                            ...
                                            <td>
                                                @if (auth()->user()->selectRole('production')->permissionCount() < 1 ||
    auth()->user()->selectRole('production')->hasPermission('raw_materials_edit'))
                                                ...
                                                @if (auth()->user()->selectRole('production')->permissionCount() < 1 ||
    auth()->user()->selectRole('production')->hasPermission('raw_materials_delete'))
