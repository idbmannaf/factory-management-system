...
@section('content')
    ...
    auth()->user()->selectRole('production')->hasPermission('stationery_materials_add'))
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="number" step="any" min="0" name="unit_value"
                                ...
                                <tbody>
                                    @forelse($stationeries as $stationery)
                                        <tr>
                                            ...
                                            <td>
                                                @if (auth()->user()->selectRole('production')->permissionCount() < 1 ||
    auth()->user()->selectRole('production')->hasPermission('stationery_materials_edit'))
                                                    <a href="" data-toggle="modal"
                                                        data-target="#edit{{ $stationery->id }}"><i
                                                            class="fas fa-edit"></i></a>
                                                @endif
                                                <a href="" data-toggle="modal" data-target="#view{{ $stationery->id }}">
                                                    <i class="fas fa-eye"></i></a>
                                                @if (auth()->user()->selectRole('production')->permissionCount() < 1 ||
    auth()->user()->selectRole('production')->hasPermission('stationery_materials_delete'))
