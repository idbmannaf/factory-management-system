                ...
                <table class="table table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$product->id}}</td>
                            <td>
                                <a href="{{route('factory.viewProductManufacturing',$product)}}" class="text-success"><i
                                        class="fas fa-eye"></i></a>
                                @if ($product->status == 'pending')
                                <a href="{{route('factory.editProductManufacturing',$product)}}" class="text-info"><i
                                ...
                                <a class='badge badge-success'
                                    href="{{route('factory.viewProductManufacturing',$product)}}"> Ready To
                                    Confirm or Reject</a>
                                @endif
                                @if ($product->status =='ready_to_stock')

                                <a class='badge badge-success'
                                    href="{{route('factory.viewProductManufacturing',$product)}}"> Ready To Stoked In</a>
                                @endif
