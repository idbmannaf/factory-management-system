                ...
                <div class="card-body sampleValue" data="1" style="background-color: #e5e5e5;">
                    <div class="row">
                        <div class="col-12 col-md-4 raw_id">
                            <select name="raw_id[]" id="raw_id" class="form-control raw" data-url="{{route('admin.checkRawBatch')}}" required>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" name="name" placeholder="Sample Name" class="form-control" required>
                        </div>
                        <div class="col-12 col-md-4">
