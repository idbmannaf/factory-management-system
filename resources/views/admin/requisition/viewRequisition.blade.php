    ...
    <section class="content">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card">
                    <form action="{{ route('admin.requisitionProcess', ['requisition' => $requisition->id]) }}"
                        method="post">
                        @csrf
                            ...
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @forelse($requisition->requisition_items()->orderBy('raw_id')->get() as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="app">
                                                        @if ($requisition->status == 'approved' || $requisition->status == 'pending_purchase')
                                ...
                                <div class="text-right">
                                    ...
                                    @elseif ($requisition->status == 'approved')
                                        <input type="hidden" name="type" value="pending_purchase">
                                        <input type="submit" class="btn btn-info" value="Pending Purchase Now">
                                    ...
                                    @elseif($requisition->status == 'approved_purchase')
                                        ...
                                        <input type="submit" class="btn btn-success" value="Purchase Now">
                                            ...
                                            @forelse($requisition->requisition_items()->orderBy('raw_id')->get() as $item)
                                                ...
                                                <tr>
                                                   ...
                                                   @elseif ($requisition->status != 'pending')
                                                    ...
                                                    <td>
                                                        @if ($requisition->status == 'approved' || $requisition->status == 'pending_purchase' || $requisition->status == 'approved_purchase')
                                                            <input type="number" value="{{ $item->quantity }}" required
                                                                name="quantity[]">
                                                        @else
                                                            {{ $item->quantity }}
                                                    ...
                                                    @endif
                                                    <td>
                                                        @if ($requisition->status == 'approved' || $requisition->status == 'approved_purchase' || $requisition->status == 'pending_purchase')
                                                            <input type="number" value="{{ $item->price }}" min="1"
                                                                required name="price[]">
                                                        @else
                                                            {{ $item->price }}
