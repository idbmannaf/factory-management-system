            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        Raw Materials <a href="{{route('downloadNow',['type'=>'materials','status'=>'raw'])}}" id="export" class="btn btn-success btn-sm float-right"> <i class="fas fa-download"></i> Export</a>
                    </div>
                </div>
                <div class="card-body">
