            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>{{ $status }} Product Manufacturing <a
                        ...
                        <div>
                            @if ($status == 'in_stocked')
                                <a href="{{ route('downloadNow', ['type' => 'readyProduct', 'status' => 'all']) }}"
                                ...
                                <tbody>
                                    @forelse ($products as $product)
                                        <tr>
                                            ...
                                            <td>{{ $product->id }}</td>
                                            <td>
                                                <a href="{{ route('admin.viewProductManufacturingAfterProccess', $product) }}"
