...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Factory Manager All</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Factory Manager All</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-widget">
                                <div class="card-header with-border">
                                    <h3 class="card-title"><i class="fa fa-th"></i> Factory Manager All
                                        <span
                                            data-href="{{ route('downloadNow', ['type' => 'role', 'status' => 'admin']) }}"
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title ">Add New Factory Manager</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="{{ route('admin.factoryManagerPost') }}">
                            {{ csrf_field() }}
