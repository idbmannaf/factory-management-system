...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Production All</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Production All</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-widget">
                            <div class="card-header with-border">
                                <h3 class="card-title"><i class="fa fa-th"></i> All Production
                                    <span data-href="{{route('downloadNow',['type'=>'role','status'=>'production'])}}" id="export" class="btn btn-success btn-sm float-right" onclick="exportTasks(event.target);"> <i class="fas fa-download"></i> Export</span>
                                </h3>
                                <div class="float-right">
                                    <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#myModal">Add New Porduction</a>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                ...
                                                                <form class="delete-admin" action="{{route('admin.deleteProduction',$user)}}" method="POST" >
                                                                    {{ csrf_field() }}
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  method="post" action="{{route('admin.addNewProduction')}}">
                        @csrf
